...
{
    public partial class FormBuscarCodigoRomance : Form
    {
        public FormBuscarCodigoRomance()
        {
            InitializeComponent();
            panelContenedorBCodigoRomance.Visible = false;
        }
            ...
            try
            {
                ...
                while (cadena != null && encontrado == false)
                {
                    ...
                    if (campo[0].Trim().Equals(libro))
                    {
                        ...
                        panelContenedorBCodigoRomance.Visible = true;
                        encontrado = true;
                    }
                    else
                    {
