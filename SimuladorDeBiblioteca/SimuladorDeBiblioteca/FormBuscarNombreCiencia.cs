...
{
    public partial class FormBuscarNombreCiencia : Form
    {
        public FormBuscarNombreCiencia()
        {
            InitializeComponent();
            panelContenedorBNombreCiencia.Visible = false;
        }
            ...
            try
            {
                ...
                while (cadena != null && encontrado == false)
                {
                    ...
                    if (campo[1].Trim().Equals(libro))
                    {
                        ...
                        panelContenedorBNombreCiencia.Visible = true;
                        encontrado = true;
                    }
                    else
                    {
