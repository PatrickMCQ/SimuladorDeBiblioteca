...
{
    public partial class FormBuscarCodigoAnimacion : Form
    {
        public FormBuscarCodigoAnimacion()
        {
            InitializeComponent();
            panelContenedorBCodigoAnimacion.Visible = false;
        }
            ...
            try
            {
                ...
                while (cadena != null && encontrado == false)
                {
                    ...
                    if (campo[0].Trim().Equals(libro))
                    {
                        ...
                        panelContenedorBCodigoAnimacion.Visible = true;
                        encontrado = true;
                    }
                    else
                    {
