...
{
    public partial class FormBuscarCodigoHistoria : Form
    {
        public FormBuscarCodigoHistoria()
        {
            InitializeComponent();
            panelContenedorBCodigoHistoria.Visible = false;
        }
            ...
            try
            {
                ...
                while (cadena != null && encontrado == false)
                {
                    ...
                    if (campo[0].Trim().Equals(libro))
                    {
                        ...
                        panelContenedorBCodigoHistoria.Visible = true;
                        encontrado = true;
                    }
                    else
                    {
